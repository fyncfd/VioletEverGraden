...
static inline void VioletEverGarden() {
    ...
    while (q--) {
        ...
        sscanf(a.c_str(), "%d-%d-%dT%d:%d:%d", 
            &tm_a.tm_year, &tm_a.tm_mon, &tm_a.tm_mday,
            &tm_a.tm_hour, &tm_a.tm_min, &tm_a.tm_sec);
        tm_a.tm_year -= 1900; 
        tm_a.tm_mon -= 1; 
                tm_a.tm_isdst = -1; 
        sscanf(b.c_str(), "%d-%d-%dT%d:%d:%d", 
            &tm_b.tm_year, &tm_b.tm_mon, &tm_b.tm_mday,
            &tm_b.tm_hour, &tm_b.tm_min, &tm_b.tm_sec);
        tm_b.tm_year -= 1900;
        tm_b.tm_mon -= 1;
        tm_b.tm_isdst = -1;
