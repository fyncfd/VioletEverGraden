...
* @Create Time: 2026-01-14 15:37:59
...
static inline void VioletEverGraden() {
    ...
    // std::vector<pii> bk; bk.push_back({-1, -1});
    // int i = 1;
    // int len = 1;
    // while (i <= N) {
    // 	if (A[i + 1] == A[i]) {
    ...
    // 			} else {
    // 				st.pop_back();
    // 				st.push_back({node1.fi, node1.se});
    // 			}
    // 		} else {
    // 			st.push_back(bk[i]);
    // 		}
